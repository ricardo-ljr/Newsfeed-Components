...
const data = [
  ...
  {
    title: "I'm a brand new article, read me please",
    date: "Jan 1st, 2019",
    firstParagraph: `Hodor hodor HODOR! Hodor hodor - hodor, hodor. Hodor hodor... Hodor hodor hodor; hodor hodor. Hodor hodor hodor, hodor, hodor
        hodor. Hodor, hodor. Hodor. Hodor, hodor - hodor... Hodor hodor hodor; hodor HODOR hodor, hodor hodor?! Hodor hodor, hodor.
        Hodor hodor hodor hodor hodor! Hodor hodor - HODOR hodor, hodor hodor hodor hodor hodor; hodor hodor? `,
...
function createArticle(
  ...
  article.append(articleParagraphOne);
  article.append(articleParagraphTwo);
  article.append(articleParagraphThree);
...
const articleCreator = document.querySelector(".articles");

data.forEach(value => {
  articleCreator.append(
    createArticle(
      value.title,
      value.date,
